...
<head>
    ...
    <title>Login Sistem Ujian CBT</title>
    ...
    <style>
        ...
        .form-container {
            background-color: rgba(31, 109, 255, 0.2); /* Biru semi-transparan yang lebih gelap */
        ...
        .checkbox-blue:checked {
            background-color: #576CBC; /* Warna checkbox ketika dicek */
            border-color: #576CBC;
        }
        .checkbox-blue:focus {
            ring-color: #3E54A3;
...
<body class="bg-cbt-blue-theme min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden">
    ...
    <div class="form-container p-8 md:p-12 rounded-3xl shadow-2xl w-full max-w-md z-10">
        <h1 class="text-4xl font-bold text-center mb-10 text-slate-100">Login CBT</h1>
        ...
        <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            ...
            <button type="submit"
                    class="btn-login w-full py-3 px-4 border border-transparent rounded-xl shadow-sm text-lg font-semibold focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400 transition duration-150 ease-in-out">
                Log In
            </button>
        </form>
        ...
        <p class="mt-10 text-center text-sm text-slate-400">
            Belum punya akun?
            <a href="register.php" class="font-medium text-link-blue">
                Daftar disini
            </a>
        </p>
    </div>
