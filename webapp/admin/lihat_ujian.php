...
<head>
    ...
    <title>Lihat Daftar Ujian - Exam Platform</title>
            ...
            <ul class="space-y-2">
                <li>
                    <a href="tambah_ujian.php" class="flex items-center p-3 rounded-lg text-blue-600 hover:bg-blue-100 transition">
                        <i class="fas fa-plus mr-3"></i> Tambah Ujian Baru
                    </a>
                </li>
                <li>
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="p-3 border-b">
                                            ...
                                            <a href="tambah_soal.php?exam_id=<?= $exam['id'] ?>" 
                                               class="inline-block px-3 py-1 bg-green-600 text-white rounded-lg hover:bg-green-700 mr-2 transition">
                                                Tambah Soal
                                            </a>
